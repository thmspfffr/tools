function h=pconn_showsurface(vc,para,varargin);
...
colors_x={'.7 .7 .7';'.7 .7 .7';'.7 .7 .7';'.7 .7 .7';'.7 .7 .7';'.7 .7 .7'};
% colors_x={'.9 .9 .9';'.9 .9 .9';'.9 .9 .9';'.9 .9 .9';'.9 .9 .9';'.9 .9 .9'};
...
% for i = 1 : length(idx)
%   
%   idx_tri1 = [idx_tri1; find(tri(:,1)==idx(i))];
%   idx_tri2 = [idx_tri2; find(tri(:,2)==idx(i))];
%   idx_tri3 = [idx_tri3; find(tri(:,3)==idx(i))];
%   
% end
%   
% k(unique([idx_tri1; idx_tri2; idx_tri3]),:)=[];
% 
% 
% h=pconn_showvc_prog_plain(tmploc,k,myviewdir,para);
% myviewdir = [-0 0 .25]
h=pconn_showvc_prog_plain(loc,tri,myviewdir,para);
hold on;
