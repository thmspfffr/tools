function tp_showsource(par_interp,cmap,sa_meg_template,para)
...
print(gcf,'-dpng',[para.filename])
%%
im = imread(para.filename);
im = im(70:end-250,350:end-310,:);imshow(im)
imwrite(im,[para.filename],'png');
